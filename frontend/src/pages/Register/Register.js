...
import characterImage from '../../assets/MangaQynLogo.png';
    ...
    return (
        <div style={styles.container}>
            <div style={styles.content}>
                ...
                <form onSubmit={handleSubmit} style={styles.form}>
                    ...
                    <a href="/api/users/google" style={styles.googleButton}>
                        <span style={styles.googleIcon}>G</span> Đăng ký với Google
                    </a>
                    <div style={styles.footer}>
                        <p style={styles.footerText}>
                            Đã có tài khoản? <Link to="/login" style={styles.registerLink}>Đăng nhập</Link>
                        </p>
            ...
            <div style={styles.character}>
                <img src={characterImage} alt="Register Character" style={styles.characterImage} />
            </div>
        </div>
    );
};
